...
window.I18N_LOCALES['en'] = {
  ...
  'channels.redirectTarget': 'Redirect Targets',
  ...
  'channels.modal.redirectTarget': 'Redirect Targets',
  ...
  'channels.noRedirect': 'No redirect',
  'channels.modelTargetCount': '{count} targets',
  'channels.targetModelPlaceholder': 'Target model name',
  ...
  'channels.saveChannelFirst': 'Save the channel before setting cooldown',
  'channels.targetModelRequired': 'Target model name is required',
  'channels.cooldownDurationPrompt': 'Enter cooldown duration in milliseconds',
  'channels.invalidCooldownDuration': 'Cooldown duration must be at least 1000 ms',
  'channels.setCooldown': 'Cooldown',
  'channels.cooldownFailed': 'Failed to set cooldown',
  'channels.cooldownSetSuccess': 'Cooldown set for target model {model}',
