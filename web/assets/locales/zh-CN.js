...
window.I18N_LOCALES['zh-CN'] = {
  ...
  'channels.redirectTarget': '重定向目标（可多目标）',
  ...
  'channels.modal.redirectTarget': '重定向目标（可多目标）',
  ...
  'channels.noRedirect': '无重定向',
  'channels.modelTargetCount': '{count} 个目标',
  'channels.targetModelPlaceholder': '目标模型名称',
  ...
  'channels.saveChannelFirst': '请先保存渠道后再设置冷却',
  'channels.targetModelRequired': '请先填写目标模型名称',
  'channels.cooldownDurationPrompt': '请输入冷却时长（毫秒）',
  'channels.invalidCooldownDuration': '冷却时长必须大于等于 1000 毫秒',
  'channels.setCooldown': '冷却',
  'channels.cooldownFailed': '设置冷却失败',
  'channels.cooldownSetSuccess': '已为目标模型 {model} 设置冷却',
